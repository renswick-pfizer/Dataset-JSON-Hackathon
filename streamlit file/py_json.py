...
if choice == 'Upload JSON':
    domain_s=["Sdtm VS","Sdtm AE","Sdtm LB","Sdtm DM","Adam VS","Adam AE","ADSL","Supp DM"]
    ...
    if data is not None:
        ...
        if choice1=="csv":
            ...
            st.write(df.head())         
            with open(choice2 +".csv",encoding='cp437') as f:
            ...
            st.write(df.head())
            with open(choice2 +".Rds",encoding='cp437') as f:
            ...
            st.write(df.head())     
            with open(choice2 +".xml",encoding='cp437') as f:
            ...
            st.write(df.head())
            with open(choice2 +".xpt",encoding='cp437') as f:
